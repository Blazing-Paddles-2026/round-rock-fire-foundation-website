...
- **Imagery:** Use RRFF-owned or expressly licensed photography only. The homepage hero uses the provided `assets/round-rock-fire-trucks-promo.jpg`; remaining placeholders are graphic treatments showing where existing Foundation photos can go. Do not replace them with stock or AI-generated imagery.
